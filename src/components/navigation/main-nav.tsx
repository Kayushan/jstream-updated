      ...
      >
       ...
       {drawerOpen && (
         <>
           ...
           />
           {/* Drawer */}
           <aside className="fixed inset-y-0 left-0 z-50 w-4/5 max-w-xs bg-background shadow-2xl flex flex-col md:hidden">
             <div className="flex items-center justify-between p-4 border-b">
               <Link to="/" onClick={() => setDrawerOpen(false)} className="flex items-center space-x-2">
